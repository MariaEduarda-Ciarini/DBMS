...
CREATE INDEX EMPLOYEES_LAST_NAME_IDX ON EMPLOYEES (
    LAST_NAME
);
...
CREATE INDEX EMPLOYEES_LAST_NAME_FIRST_NAME_IDX ON EMPLOYEES(
    LAST_NAME,
    FIRST_NAME
);
...
ORDER BY
    IX.INDEX_NAME, IC.COLUMN_POSITION;