SELECT
    LAST_NAME,
    TO_CHAR (HIRE_DATE,
    'DD/MM/YYYY HH24:MI:SS') DT_ADMISSÃO
FROM
    EMPLOYEES;
...
SELECT
    FIRST_NAME,
    TO_CHAR (HIRE_DATE,
    'DD, "de" Month "de" YYYY') DT_ADMISSÃO
FROM
    EMPLOYEES;
...
SELECT
    FIRST_NAME,
    TO_CHAR (HIRE_DATE,
    'FMDD, "de" Month "de" YYYY') DT_ADMISSÃO
FROM
    EMPLOYEES;
