...
SET SERVEROUTPUT ON
DECLARE VNUMERO NUMBER(11, 2) := 1500.50;
BEGIN DBMS_OUTPUT.PUT_LINE('Número = ' || VNUMERO);
END;
-- Variável Type CHAR e VARCHAR2
DECLARE VCARACTERTAMFIXO CHAR(2) := 'SP';
...
END;
-- Variável Type DATE
DECLARE VDATA1 DATE := '05/07/23';
VDATA2 DATE := '05/07/2023';
BEGIN DBMS_OUTPUT.PUT_LINE('Data1 = ' || VDATA1);
