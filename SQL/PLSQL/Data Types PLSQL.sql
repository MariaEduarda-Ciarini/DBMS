...
SET SERVEROUTPUT ON
DECLARE VDATABASE VARCHAR2 (40);
BEGIN VDATABASE := 'Oracle 19c';
DBMS_OUTPUT.PUT_LINE (
    'Valor da variável vDatabase = ' || VDATABASE
);
END;
DECLARE VNUMBER NUMBER (11, 2) := 2350.90;
...
BEGIN DBMS_OUTPUT.PUT_LINE('Numero = ' || VNUMBER);
DBMS_OUTPUT.PUT_LINE(
    'String Caracteres Tam Fixo = ' || VCHARACTERSFIX
);
DBMS_OUTPUT.PUT_LINE(
    'String Caracteres Tam Variável = ' || VCHARACTERSVARI
);
IF VBOOLEANO = TRUE THEN DBMS_OUTPUT.PUT_LINE('Booleano = ' || 'TRUE');
ELSE DBMS_OUTPUT.PUT_LINE('Booleano = ' || 'FALSE OR NULL');
END IF;
...
DBMS_OUTPUT.PUT_LINE(
    'Timestamp with zone = ' || VTIMESTAMPTZ
);
DBMS_OUTPUT.PUT_LINE(
    'String Caracteres Tam Fixo = ' || VCHARACTERSFIXUNIVERSAL
);
DBMS_OUTPUT.PUT_LINE(
    'String Caracteres Tam Variável = ' || VCHARACTERSVARIUNIVERSAL
);
